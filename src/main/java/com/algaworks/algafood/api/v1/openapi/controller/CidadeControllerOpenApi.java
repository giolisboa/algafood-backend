...
public interface CidadeControllerOpenApi {
    ...
    CidadeModel buscar(@ApiParam(value = "ID de uma cidade", example = "1", required = true) Long idCidade);
    ...
    CidadeModel atualizar(@ApiParam(value = "ID de uma cidade", example = "1", required = true) Long idCidade,
