...
public interface RestauranteProdutoFotoControllerOpenApi {
    ...
    void excluir(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long idRestaurante,
            @ApiParam(value = "ID do produto", example = "1", required = true) Long idProduto);
    ...
    FotoProdutoModel buscar(@ApiParam(value = "ID do restaurante", example = "1", required = true) Long idRestaurante,
            @ApiParam(value = "ID do produto", example = "1", required = true) Long idProduto);

    @ApiOperation(value = "Busca a foto do produto de um restaurante", hidden = true)
    ResponseEntity<?> servir(Long idRestaurante, Long idProduto, String acceptHeader)
