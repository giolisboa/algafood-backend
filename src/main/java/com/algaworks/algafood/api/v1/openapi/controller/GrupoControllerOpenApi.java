...
public interface GrupoControllerOpenApi {
    ...
    GrupoModel buscar(@ApiParam(value = "ID de um grupo", example = "1", required = true) Long idGrupo);
    ...
    GrupoModel atualizar(@ApiParam(value = "ID de um grupo", example = "1", required = true) Long idGrupo,
