...
public interface UsuarioControllerOpenApi {
    ...
    UsuarioModel buscar(@ApiParam(value = "ID do usuário", example = "1", required = true) Long idUsuario);
    ...
    UsuarioModel atualizar(@ApiParam(value = "ID do usuário", example = "1", required = true) Long idUsuario,
    ...
    void alterarSenha(@ApiParam(value = "ID do usuário", example = "1", required = true) Long idUsuario,
