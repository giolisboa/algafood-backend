...
public interface UsuarioGrupoControllerOpenApi {
    ...
    ResponseEntity<Void> desassociar(@ApiParam(value = "ID do usuário", example = "1", required = true) Long idUsuario,
    ...
    ResponseEntity<Void> associar(@ApiParam(value = "ID do usuário", example = "1", required = true) Long idUsuario,
            @ApiParam(value = "ID do grupo", example = "1", required = true) Long idGrupo);
