...
public class CidadeController {
    ...
    @GetMapping("/{idCidade}")
    public CidadeModel buscar(@ApiParam(value = "ID de uma cidade", example = "1") @PathVariable Long idCidade) {
        return cidadeModelAssembler.toModel(cidadeService.buscar(idCidade));
    }
    ...
    public CidadeModel atualizar(
            @ApiParam(value = "ID de uma cidade", example = "1") @PathVariable Long idCidade,
