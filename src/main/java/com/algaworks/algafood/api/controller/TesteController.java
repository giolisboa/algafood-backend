...
public class TesteController {
    ...
    public List<Restaurante> restaurantesPorNomeCozinha(String texto, String nomeCozinha) {
        return restauranteRepository.consultarPorNomeCozinha(texto, nomeCozinha);
    }
