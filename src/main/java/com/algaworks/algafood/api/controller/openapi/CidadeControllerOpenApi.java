...
public interface CidadeControllerOpenApi {
    ...
    public CidadeModel buscar(@ApiParam(value = "ID de uma cidade", example = "1") Long idCidade);
    ...
    public CidadeModel atualizar(@ApiParam(value = "ID de uma cidade", example = "1") Long idCidade,
